...
online version: https://docs.microsoft.com/powershell/module/az.dnsresolver/get-azdnsresolverdnsforwardingruleset
schema: 2.0.0
---
...
### Example 1: List all DNS forwarding rulest under the subscription 
```powershell
